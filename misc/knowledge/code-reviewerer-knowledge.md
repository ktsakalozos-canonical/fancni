...
- **IPv6 Inputs:** The `ComputeSubnet`, `ComputeGateway`, and `validateOverlay` functions reject IPv6 overlays using `To4() == nil`. Improve error handling to provide explicit feedback for IPv6 inputs.
